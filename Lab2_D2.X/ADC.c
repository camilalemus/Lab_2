...
void ADC_init(uint8_t ADCSbit,uint8_t Channel, uint8_t Justified, uint8_t Vref){
    ...
    switch (Channel) {
        case 0:
            ADCON0bits.CHS = 0000; //Channel 0
            break;
        case 1:
            ADCON0bits.CHS = 0001; //Channel 1
            break;
        case 2:
            ADCON0bits.CHS = 0010; //Channel 2
            break;
        case 3:
            ADCON0bits.CHS = 0011; //Channel 3
            break;
        case 4:
            ADCON0bits.CHS = 0100; //Channel 4
            break;
        case 5:
            ADCON0bits.CHS = 0101; //Channel 5
            break;
        case 6:
            ADCON0bits.CHS = 0110; //Channel 6
            break;
        case 7:
            ADCON0bits.CHS = 0111; //Channel 7
            break;
        case 8:
            ADCON0bits.CHS = 1000; //Channel 8
            break;
        case 9:
            ADCON0bits.CHS = 1001; //Channel 9
            break;
        case 10:
            ADCON0bits.CHS = 1010; //Channel 10
            break;
        case 11:
            ADCON0bits.CHS = 1011; //Channel 11
            break;
        case 12:
            ADCON0bits.CHS = 1100; //Channel 12
            break;
        case 13:
            ADCON0bits.CHS = 1101; //Channel 13
            break;
        case 14:
            ADCON0bits.CHS = 1110; //CV REF
            break;
        case 15:
            ADCON0bits.CHS = 1111; //FIXED REF (0.6V fixed voltage reference)
            break;
        default:
            ADCON0bits.CHS = 0010; //Channel 2
    }
